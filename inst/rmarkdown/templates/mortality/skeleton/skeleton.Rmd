...
`r fmt_count(study_data_cleaned, sex == "Male")` males (unweighted). 

The highest number of surveyed indivduals (unweighted) were in the `r descriptive(study_data_cleaned, "age_group") %>% slice(which.max(n)) %>% pull(age_group)` year age group. 

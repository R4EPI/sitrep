...
#   mutate(uid = str_c({index}, "_", {index_y}))
...
DATEVARS <- filter(study_data_dict, type == "date") %>% 
...
study_data_cleaned <- study_data_cleaned %>% 
  mutate(hh_id = str_glue("{village}_{q65_iq4}"))
...
`r death_props_strat %>% pull("District A n")`, 
...
`r death_props_strat %>% pull("District B n")`, 

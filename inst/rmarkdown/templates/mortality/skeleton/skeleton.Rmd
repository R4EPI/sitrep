...
death_props <- survey_design %>% 
  select(died) %>% 
  ## note add_ci() does not allow logical variables 
  ## type "categorical" changes to a character variable
...
`r inline_text(death_props_strat, variable = "died", level = "TRUE", column = "stat_1")`, 
with a weighted confidence interval of
`r inline_text(death_props_strat, variable = "died", level = "TRUE", column = "ci_stat_1")`.  
In comparison, the weighted number and proportion of deaths in District B was
`r inline_text(death_props_strat, variable = "died", level = "TRUE", column = "stat_2")`, 
the weighted confidence interval was 
`r inline_text(death_props_strat, variable = "died", level = "TRUE", column = "ci_stat_2")`.  

...
study_data_cleaned <- study_data_cleaned %>%
  ...
  # label those that were present at the start/end
  mutate(startcause = if_else(startdate == recall_start, "Present at start", startcause)) %>%
  mutate(endcause = if_else(enddate == recall_end, "Present at end", endcause))

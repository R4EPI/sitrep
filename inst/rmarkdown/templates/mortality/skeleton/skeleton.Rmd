...
study_data_cleaned$endmonth <- months(study_data_cleaned$enddate)
# set factor levels for months variable 
study_data_cleaned$endmonth <- factor(study_data_cleaned$endmonth, 

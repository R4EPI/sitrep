...
# paste these together seperated by a endash 
...
study_data_cleaned %>% 
  tab_linelist(flen, fwei, fwfl, transpose = "value", na.rm = FALSE, col_total = TRUE) %>% 
...
overall <- survey_design %>% 
  ...
  tab_survey(indicators[10:12], keep = 'TRUE', transpose = "variable", na.rm = TRUE) %>% 
...
overall <- survey_design %>% 
  ...
  # transpose flips the table to indicators as columns 
  # important to drop missings! use na.rm = TRUE)
  tab_survey(indicators[4:6], keep = 'TRUE', transpose = "variable", na.rm = TRUE) %>% 
  # add in an age_group variable to be able to bind to age_group table below 
  mutate(age_group = "Overall") %>% 
  # reorganise columns so can bind to age_group table below 
  select(age_group, everything())
...
overall <- survey_design %>% 
  ...
  # transpose flips the table to indicators as columns 
  # important to drop missings! use na.rm = TRUE)
  tab_survey(indicators[7:9], keep = 'TRUE', transpose = "variable", na.rm = TRUE) %>% 
  # add in an age_group variable to be able to bind to age_group table below 
  mutate(age_group = "Overall") %>% 
  # reorganise columns so can bind to age_group table below 
  select(age_group, everything())
...
overall <- survey_design %>% 
  ...
  # transpose flips the table to indicators as columns 
  # important to drop missings! use na.rm = TRUE)
  tab_survey(indicators[1:3], keep = 'TRUE', transpose = "variable", na.rm = TRUE) %>% 
  # add in an age_group variable to be able to bind to age_group table below 
  mutate(age_group = "Overall") %>% 
  # reorganise columns so can bind to age_group table below 
  select(age_group, everything())

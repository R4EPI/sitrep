---
title: "Diphtheria outbreak report"
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
INTRODUCTION: This is a script intended to create a outbreak report describing the basic epidemiology of a diphtheria outbreak, using a diphtheria linelist in MSF intersection data format. It is accompanied by the Diphtheria Outbreak Report Guide - please read this to understand how to edit and run this file.
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Rmarkdown set up: See section 3.2.2 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Key definitions: See section 3.2.3 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r definitions}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Setting plot defaults: See section 3.2.4 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r set_plot_defaults}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import population data:See section 3.3.1 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_raw <- gen_data("Diphtheria_intersectional")
```


<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import linelist data: See section 3.3.2 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Browse data: See section 3.3.3 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_raw |> 
  select(hospitalised_yn,  
         ...
         antibio_yn,  
         dat_administered,  
         vacci_diphtheria_status,  
         vacci_diphtheria_doses,  
         date_hospitalisation_end,  
         lab_result_c_diphtheriae,  
         outcome,  
         final_main_diagnosis,  
) |> 
  tbl_summary()
```
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise dates: See section 3.4.1 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r standardise_dates}
...
linelist_processing <- linelist_processing |>
  mutate(date_symptom_start = if_else(
    !is.na(date_notification) & !is.na(date_symptom_start) & date_notification >= date_symptom_start, 
    date_symptom_start,
    NA_Date_)) 
  
# Coalesce dates ---------------------------------------------------------
# Use notification date if onset not available

linelist_processing <- linelist_processing |>
  mutate(date_combined = coalesce(date_symptom_start, date_notification))

# Count how many date_onset were missing and replaced by notification date
linelist_processing <- linelist_processing |> 
  mutate(date_source = case_when(is.na(date_symptom_start) & !is.na(date_combined) & date_combined == date_notification ~ "Notification date",
                                 !is.na(date_symptom_start) ~ "Onset date"))
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create age group column: See section 3.4.2 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_age_group}
...
linelist_processing <- linelist_processing |> 
  mutate(
    ...
    age_group = case_when(
      ...
      age_years >= 5 & age_years < 11 ~ "5-10",
      age_years >= 11 & age_years < 15 ~ "11-14",
      age_years >= 15 ~ "15+",
      TRUE ~ NA_character_
    ),
    age_group = factor(age_group, levels = c("<1", "1-4", "5-10", "11-14", "15+"), ordered = TRUE)
  )
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise and correct columns: See section 3.4.3 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create and order other analysis columns: See section 3.4.4 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_vars}
...
## Ensuring other columns are factoral so presented in correct order
  ...
  mutate(disease_severity = factor(disease_severity,
                             levels = c("Mild",
                                        "Moderate", 
                                        "Severe"))) |> 
           
  mutate(lab_result_c_diphtheriae = factor(lab_result_c_diphtheriae,
                             levels = c("Positive",
                                        "Negative", 
                                        "Pending",
                                        "Uncertain"))) |> 
  
  mutate(vacci_diphtheria_status = factor(vacci_diphtheria_status, 
                                  levels= c("Fully vaccinated",
                                            "Partially vaccinated",
                                            "Not vaccinated")))|> 
  
  mutate(vacci_diphtheria_doses = factor(vacci_diphtheria_doses, 
  ...
  mutate(outcome = factor(outcome, 
                                levels = c("Recovered", 
                                           ...
                                           "LAMA",
                                           "Referred"))) |> 
  mutate(final_main_diagnosis = factor(final_main_diagnosis, 
                                levels = c("Respiratory diphtheria", 
                                           "Systemic diphtheria",
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Duplicates: See section 3.4.5 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Remove unused data: See section 3.4.6 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_processing <- linelist_processing |> 
  filter(date_symptom_start <= reporting_date | is.na(date_symptom_start))

## For example, this removes rows without both a date of onset and ID number:
# linelist_processing <- linelist_processing |> 
#   filter(!is.na(case_id) & !is.na(date_symptom_start)) 

```

<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Save cleaned data: See section 3.4.7 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
export(linelist_cleaned, str_glue("diphtheria_linelist_cleaned_{Sys.Date()}.RDS"))
```

# Recommendations
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Recommendations: See section 3.5.1 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

\newpage
# Summary
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Summary statistics: See section 3.5.2 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
- `r nrow(linelist_cleaned)` diphtheria cases have been reported since the start of the outbreak.
...
- There were `r fmt_count(linelist_cleaned, lab_result_c_diphtheriae == "Positive")` lab-confirmed cases.
- There were `r fmt_count(linelist_cleaned, disease_severity == "Severe")` severe cases.
- The overall CFR was `r round(nrow(linelist_cleaned |> filter(died==T))/nrow(linelist_cleaned)*100,1)`%. 

\newpage
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Epicurve: See section 3.5.3 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
**Diphtheria cases by week of symptom onset**  
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Age and sex distribution: See section 3.5.4 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
**Distribution of age-group among diphtheria cases, by sex**  
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Symptoms, underlying conditions, and treatment: See section 3.5.5 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

**Symptoms and underlying conditions, by age group**  
_Percentages calculated among those with non-missing information_
```{r symptoms}

linelist_cleaned |> 
  select(neck_swelling, pseudo_membrane, disease_severity, 
         comorb_ckd, 
         malnutrition, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(neck_swelling = "Neck swelling",
                           pseudo_membrane = "Pseudomembrane",
                           disease_severity = "Diphtheria disease severity", 
...
\newpage  
**Distribution of malnourishment levels, by diphtheria severity**  
_Percentages calculated among those with non-missing information_
```{r mal_severity}

linelist_cleaned |> 
  select(disease_severity, malnutrition) |> 
  tbl_summary(percent = "column",
              by = "disease_severity",
              label = list(malnutrition = "Malnutrition"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Antibiotic and Diphtheria Antitoxin (DAT) treatment, by age group**  
_Percentages calculated among those with a "Yes" or "No" result per treatment_
```{r treatment}

linelist_cleaned |> 
  select(antibio_yn, dat_administered, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(antibio_yn = "Antibiotics admininistered",
                           dat_administered = "Diphtheria antitoxin administered"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Attack rate: See section 3.5.6 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_cleaned |> 
  ...
  mutate(age_group = factor(age_group, levels = c("<1", "1-4", "5-10", "11-14", "15+", "Total"), ordered = TRUE)) |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Vaccination, laboratory results, and outcomes: See section 3.5.7 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_cleaned |> 
  select(vacci_diphtheria_status, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_diphtheria_status = "Previously vaccinated"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
_Percentages calculated among those with non-missing dose information among those previously fully or partially vaccinated_
```{r vaccination_dosesl}

linelist_cleaned |> 
  filter(vacci_diphtheria_status %in% c("Fully vaccinated", "Partially vaccinated")) |> 
  select(vacci_diphtheria_doses, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_diphtheria_doses = "Number of doses"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
linelist_cleaned |> 
  select(lab_result_c_diphtheriae, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(lab_result_c_diphtheriae = "Laboratory result"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Final diagnosis and outcome of cases by age group**  
_Percentages calculated among those with non-missing information_
```{r diagnosis_outcome_age}

linelist_cleaned |> 
  select(final_main_diagnosis, outcome, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(outcome = "Outcome",
                           final_main_diagnosis = "Final diagnosis"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Final diagnosis and outcome of cases by administration of DAT**
```{r diagnosis_outcome_dat}

linelist_cleaned |> 
  select(final_main_diagnosis, outcome, dat_administered) |> 
  tbl_summary(percent = "column",
              by = "dat_administered",
              label = list(outcome = "Outcome",
                           final_main_diagnosis = "Final diagnosis"),
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic distribution - tables: See section 3.5.8 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
Geographic distribution - maps: See section 3.5.9 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic details: See section 3.5.10 in the diphtheria outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

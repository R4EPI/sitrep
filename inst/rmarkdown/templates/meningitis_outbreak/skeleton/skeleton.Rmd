...
If available, you can also describe the cases by lab results 

```{r describe_by_labs}
# get counts and proportions for all variables named in LABS
multi_descriptive(linelist_cleaned, LABS, .id = "Lab test") %>% 
  # re-order columns (drop total_prop too)
  select("Lab test", Positive_n, Positive_prop, Negative_n, Negative_prop, 
         Unknown_n, Unknown_prop, Total_n) %>% 
  # rename accordingly
  rename(

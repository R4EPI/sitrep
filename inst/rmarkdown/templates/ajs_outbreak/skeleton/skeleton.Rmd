...
# install {linelist} package from github
...
linelist_cleaned %>%
  ...
  tidyr::complete(age_group, 
                  fill = list(deaths = 0, 
                              population = 0, 
                              cfr = 0, 
                              ci = "-")) %>% # Ensure all levels are represented
...
If needed, you can plot a monthly epicurve. You can also do this by quarter, or
year.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
for (week in unique(cases$epiweek)) {
  ...
  print(
    barplot + map_plot + plot_annotation(
         title   = str_glue("Epiweek: {current_week}"),

...
## set current week 
reporting_week <- as.aweek("2019-W25")
...
# population_data_region <- gen_population(total_pop = 5000,         
#   groups = c("Village A", "Village B", "Village C", "Village D"),  
#   proportions = c(0.221, 0.174, 0.355, 0.245),
...
# linelist_cleaned <- linelist_cleaned %>%
#   mutate(patient_origin_free_text = case_when(
#     patient_origin_free_text == "Valliages D"       ~ "Village D",
#     patient_origin_free_text == "VillageD"          ~ "Village D",
#     patient_origin_free_text == "Town C"            ~ "Village C"
#   ))

...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
All text within <! > will not show in your final document. These comments are
used to explain the template. You can delete them if you want.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
# (the standard is to start on Monday)
...
## MSF AJS Dictionary ----------------------------------------------------------
## This step shows you the data dictionary.

## The data dictionary has variable names in the data_element_shortname column. 
## Possible values for each variable are specified in code and name columns.
...
```{r prep_nonDHIS_data, warning = FALSE, message = FALSE, eval = FALSE}
## MSF AJS Dictionary ----------------------------------------------------------
## This step shows you the data dictionary.
...
## You will need to recode your variables to match the data dictionary.
...
- You can read in a spreadsheet with age group and region data. (You can see an
...
# The variable DIED will be binary -- if patient died or not
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
age_pyramid_under_two

This chunk creates a separate age/sex pyramid for children under 2
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
If you have no deaths reported, the table will not work well.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
by sex. If you have no deaths reported, the table will not work well.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
This chunk gives the case fatality ratio among inpatients with outcomes, divided
by age group. If you have no deaths reported, the table will not work well.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
use this. If you have no deaths, the table will not work well.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
- Determine if you have a polygon or point shapefile.
- Create table with categories of counts or ARs by region.
- Join your table with your shapefile.
- Choose which variable (for polygons) or color (for points) you will use.
...
#   geom_sf(data = mapsub, aes(fill = categories), 
#           shape = 21, size = 5, 
#           color = "black") +
#   
#   # needed to avoid gridlines being drawn
...
The chunk will walk you through:
- Data preparation
- 

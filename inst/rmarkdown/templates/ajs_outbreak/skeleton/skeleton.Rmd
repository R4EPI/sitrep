...
linelist_raw <- gen_data("AJS", varnames = "data_element_shortname")
...
## Non-standard data --------------------------------------------------------------
## Use this section if you did not have a DHIS2 data dictionary. 
...
linelist_cleaned <- linelist_cleaned %>%
  mutate(
    across(
      ...
      .fns = ~fct_relevel(.x, "Positive", "Negative", "Not done"))) %>% 

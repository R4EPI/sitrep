...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
INTRODUCTION: This is a script intended to create a outbreak report describing the basic epidemiology of a measles outbreak, using a measles linelist in MSF intersection data format. It is accompanied by the Measles Outbreak Report Guide - please read this to understand how to edit and run this file.
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Set up: See section 3.2.1 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Key definitions: See section 3.2.2 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r definitions}

# 1) Define geographics --------------------------

adm1_residence_name <- "Province"
adm2_residence_name <- "District"
adm3_residence_name <- "Village"

# 2) Define reporting week ------------------------

## 2A) replace the date below with the reporting date
reporting_date <- ymd("2018-04-23")

## 2B) Set the reporting week below 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Setting plot defaults: See section 3.2.3 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r set_plot_defaults}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import population data:See section 3.3.1 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
# population_data_age <- import(here::here("Data", "population.xlsx"), which = "Sheet1")
# population_data_adm2 <- import(here::here("Data", "population.xlsx"), which = "Sheet1")
...
population_data_age <- gen_population(total_pop = 5000,
  groups = c("0-4", "5-9", "10-14", "15+"),
  proportions = c(0.068, 0.3622, 0.276, 0.2938),
  strata = NULL) |>
...
linelist_raw <- gen_data("Measles_intersectional")
```


<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import linelist data: See section 3.3.2 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Browse data: See section 3.3.3 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
## view columns (excluding identifiers)
linelist_raw |> 
  select(sex_id, 
         age_num, 
         age_unit, 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise dates: See section 3.4.1 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r standardise_dates}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create age group columns: See section 3.4.2 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_age_group}

## create an age group column by specifying categorical breaks
linelist_processing <- linelist_processing |> 
  mutate(age_years = if_else(age_unit=="Month", age_num/12, age_num)) |> 
  mutate(age_group = age_categories(
    age_years,
    breakers = c(0, 5, 10, 15),
    ceiling = FALSE)) |> 

## create age group column based on months
  mutate(age_months = if_else(age_unit=="Month", age_num, age_num*12)) |> 
  mutate(age_group_mon = age_categories(
    age_months, 
    breakers = c(0, 6, 9, 12, 24, 36, 47, 59), 
    ceiling = FALSE)) |> 
  
# Create age group variable for combination of months and years (with additional code for correct label and order)
    mutate(age_group_combined = paste0(age_categories(
          age_months,
          breakers = c(0, 6, 9, 12, 24, 36, 47, 59,120,180),
          ceiling = FALSE), "m"),  
    age_group_combined = case_when(age_group_combined == "59-119m" ~ "59m-9y",
                                   age_group_combined == "120-179m" ~ "10-14y",
                                   age_group_combined == "180+m" ~ "15y+",
                                   TRUE ~ age_group_combined),

      age_group_combined = factor(
      age_group_combined,
      levels = c(
        "0-5m", "6-8m", "9-11m", "12-23m",
        "24-35m", "36-46m", "47-58m",
        "59m-9y", "10-14y", "15y+"
      ), ordered = TRUE
    ))
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise and correct columns: See section 3.4.3 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
## Change all unknown or spaces to NA
linelist_processing <- linelist_processing |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create and order other analysis columns: See section 3.4.4 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_vars}
...
## Ensuring other columns are factoral so presented in correct order
   mutate(
    vacci_measles_yn = factor(vacci_measles_yn, 
                              levels = c("Yes - card", 
                                         "Yes - oral", 
                                         "No", 
                                         "Uncertain")),
    vacci_measles_doses = factor(vacci_measles_doses, 
                                 levels = c("1 dose", "2 doses", "3 doses", "4 doses or more", "Uncertain")),
    muac_adm = factor(muac_adm, 
                      levels = c("Green (125+ mm)", "Yellow (115 - 124 mm)", "Red (<115 mm)")))    |> 
  
  mutate(date_source = factor(date_source, levels = c("Onset date", 
                                                          "Notification date"))) |> 
  
  mutate(outcome = factor(outcome,
                          levels = c("Dead in facility",
                                     "Discharged",
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Duplicates: See section 3.4.5 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Remove unused data: See section 3.4.6 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Save cleaned data: See section 3.4.7 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
export(linelist_cleaned, str_glue("measles_linelist_cleaned_{Sys.Date()}.RDS"))
```

# Recommendations
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Recommendations: See section 3.5.1 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

\newpage
# Summary
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Summary statistics: See section 3.5.2 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
- `r nrow(linelist_cleaned)` measles cases have been reported since the start of the outbreak.
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Epicurve: See section 3.5.3 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Age and sex distribution: See section 3.5.4 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
- Among `r fmt_count(linelist_cleaned, !is.na(age_group))` cases with available age information, `r fmt_count(linelist_cleaned, age_years<4)` were cases under 4 years of age, and `r fmt_count(linelist_cleaned, age_years<2)` were cases under 2 years of age.


**Distribution of age-group among measles cases, by sex: age in years**  
...
**Distribution of age-group among measles cases, by sex: detailed age groups in months and years**  
_Age-group percentages calculated among those with non-missing age_
```{r total_props_agegroup_sex_detailed}

linelist_cleaned |> 
  select(age_group_combined, sex_id) |> 
  mutate(sex_id = forcats::fct_explicit_na(sex_id, "Missing")) |>
  tbl_summary(by = sex_id,
              percent = "cell",
              label = list(age_group_combined = "Age group"),
              missing_text = "[Missing]") |> 
  add_overall() |> 
  ## make variable names bold 
  bold_labels() |> 
...
**Age-sex pyramid: all measles cases**  
...
**Age-sex pyramid: measles cases in children less than 59 months**  
_Excludes `r fmt_count(linelist_cleaned, is.na(date_combined) | is.na(sex_id))` of `r nrow(linelist_cleaned)` cases with missing age or sex information_
```{r age_pyramid_detail, warning=FALSE, fig.height=5}

# age sex pyramid
age_pyramid(linelist_cleaned |> filter(age_months<59),
                  age_group = "age_group_mon", 
                  split_by = "sex_id") + 
  epicurve_labels +
  scale_fill_manual(values = c("#3182bd", "gray")) +
  labs(y = "Cases (n)", x = "Age group (months)") + # change axis  labels
  theme(legend.position = "bottom",     # move legend to bottom
        legend.title = element_blank(), # remove title
        text = element_text(size = 18)  # change text size
       )
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Attack rate: See section 3.5.5 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_cleaned |> 
  ...
  mutate(age_group = factor(age_group, levels = c("0-4", "5-9", "10-14", "15+", "Total"), ordered = TRUE)) |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Other characteristics and outcomes: See section 3.5.6 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

\newpage
# Other case characteristics

**Vaccination and nutritional status of cases by age group**  
_Percentages calculated among those with non-missing information_
```{r vaccination_nutritional}

linelist_cleaned |> 
  select(vacci_measles_yn, muac_adm, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_measles_yn = "Previously vaccinated",
                           muac_adm = "Nutritional status"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
_Percentages calculated among those previously vaccinated cases with non-missing dose information_
```{r vaccination_doses}

linelist_cleaned |> 
  filter(str_detect(vacci_measles_yn, "Yes")) |> 
  select(vacci_measles_doses, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_measles_doses = "Doses among previously vaccinated"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Outcomes of cases by age group**  
_Percentages calculated among those with non-missing information_
```{r outcomes}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic distribution - tables: See section 3.5.7 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Geographic distribution - maps: See section 3.5.8 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic details: See section 3.5.9 in the measles outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

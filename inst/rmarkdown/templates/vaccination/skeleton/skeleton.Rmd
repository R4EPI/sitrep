...
survey_design %>% 
  tabulate_survey(vaccination_status_simple) %>%
  kable()
```
...
# return weighted counts and weighted proportions 
survey_design %>% 
  tabulate_survey(vaccination_status) %>%
  kable()
```
...
# return weighted counts and weighted proportions 
survey_design %>% 
  tabulate_survey(vaccination_status_simple, sex) %>%
  kable()
```
...
# return weighted counts and weighted proportions 
survey_design %>% 
  tabulate_survey(vaccination_status, sex) %>%
  kable()
```
...
# return weighted counts and weighted proportions 
survey_design %>% 
  tabulate_survey(age_group, vaccination_status_simple) %>%
  kable()
```
...
# return weighted counts and weighted proportions 
survey_design %>% 
  tabulate_survey(age_group, vaccination_status) %>%
  kable()
```

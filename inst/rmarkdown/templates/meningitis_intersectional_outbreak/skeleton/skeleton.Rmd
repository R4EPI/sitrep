...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
INTRODUCTION: This is a script intended to create a outbreak report describing the basic epidemiology of a meningitis outbreak, using a meningitis linelist in MSF intersection data format. It is accompanied by the Meningitis Outbreak Report Guide - please read this to understand how to edit and run this file.
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Rmarkdown set up: See section 3.2.1 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Key definitions: See section 3.2.2 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r definitions}

# Define geographics --------------------------

adm1_residence_name <- "Province"
adm2_residence_name <- "District"
adm3_residence_name <- "Area"
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Setting plot defaults: See section 3.2.3 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r set_plot_defaults}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import population data:See section 3.3.1 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
population_data_age <- gen_population(total_pop = 10000,
                                      groups = c("<1", "1-4", "5-14", "15-29", "30+"),
                                      proportions = c(0.04, 0.16, 0.20, 0.25, 0.35),
                                      strata = NULL) |>
...
linelist_raw <- gen_data("Meningitis_intersectional")

```


<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Import linelist data: See section 3.3.2 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Browse data: See section 3.3.3 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_raw |> 
  select(patient_sex,
         ...
         adm2_residence,
         adm3_residence,
         patient_origin_status,
         date_notification,
         date_onset,
         sympt_fever,
         sympt_neck_stiffness,
         sympt_vomitting,
         sympt_altered_consciousness,
         sympt_purpura,
         malnut_adm,
         malaria_rdt,
         vacci_status_nm,
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise dates: See section 3.4.1 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r standardise_dates}
...
linelist_processing <- linelist_processing |>
  mutate(date_onset = if_else(
    !is.na(date_notification) & !is.na(date_onset) & date_notification >= date_onset, 
    date_onset,
    NA_Date_)) 
...
linelist_processing <- linelist_processing |>
  mutate(date_combined = coalesce(date_onset, date_notification))

# Count how many date_onset were missing and replaced by notification date
linelist_processing <- linelist_processing |> 
  mutate(date_source = case_when(is.na(date_onset) & !is.na(date_combined) & date_combined == date_notification ~ "Notification date",
                                 !is.na(date_onset) ~ "Onset date")) 

# Create column with week labels --------------------------------------

## Epi week for symptom start, notification date, and combined
linelist_processing <- linelist_processing |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create age group columns: See section 3.4.2 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_age_group}
...
linelist_processing <- linelist_processing |> 
  mutate(
    ...
    age_group = case_when(
      ...
      age_years >= 15 & age_years < 30 ~ "15-29",
      age_years >= 30 ~ "30+",
      TRUE ~ NA_character_
    ),
    age_group = factor(age_group, levels = c("<1", "1-4", "5-14", "15-29", "30+"), ordered = TRUE)
  )

```

<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Standardise and correct columns: See section 3.4.3 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Create and order other analysis columns: See section 3.4.4 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
```{r create_vars}
...
linelist_processing <- linelist_processing |> 
  mutate(died = str_detect(outcome, "Dead")) |> 

## Ensuring other columns are factoral so presented in correct order#
  mutate(patient_origin_status = factor(patient_origin_status,
                                        levels = c("Host",
                                                   "Internally displaced",
                                                   "Returnee",
                                                   "Refugee"))) |> 
  
  mutate(malnut_adm = factor(malnut_adm,
                             levels = c("Not malnourished",
                                        "MAM", 
                                        "SAM"))) |> 
           
           
  mutate(malaria_rdt = factor(malaria_rdt,
                             levels = c("Positive",
                                        "Negative", 
                                        "Not done"))) |> 
  
  mutate(vacci_status_nm = factor(vacci_status_nm, 
                                  levels= c("Yes",
                                            "No", 
                                            "Not target")))|> 
  
  mutate(vacci_card_nm = factor(vacci_card_nm, 
                                levels = c("Yes",
                                           "No"))) |> 
  mutate(latex_result = factor(latex_result, 
                             levels = c("N. meningitidis A",
                                        "N. meningitidis B/E. coli",
                                        "N. meningitidis C",
                                        "N. meningitidis X",
                                        "N. meningitidis W/Y",
                                        "N. meningitidis others",
...
levels_culture <- c("N. meningitidis A",
                                          "N. meningitidis B",
                                          "N. meningitidis C",
                                          "N. meningitidis X",
                                          "N. meningitidis W",
  ...
  linelist_processing <- linelist_processing |> 
    mutate(culture_result = factor(culture_result, 
                               levels = levels_culture)) |> 
  
    mutate(pcr_result = factor(pcr_result, 
                               levels = levels_culture)) |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Duplicates: See section 3.4.5 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_processing <- linelist_processing |> 
  distinct(case_id, patient_sex, age_group, .keep_all = TRUE)
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Remove unused data: See section 3.4.6 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_processing <- linelist_processing |> 
  filter(date_onset <= reporting_date | is.na(date_onset))

## For example, this removes rows without both a date of onset and ID number:
# linelist_processing <- linelist_processing |> 
#   filter(!is.na(case_id) & !is.na(date_onset)) 

```

<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Save cleaned data: See section 3.4.7 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
export(linelist_cleaned, str_glue("meningitis_linelist_cleaned_{Sys.Date()}.RDS"))
```

# Recommendations
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Recommendations: See section 3.5.1 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

\newpage
# Summary
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Summary statistics: See section 3.5.2 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
- `r nrow(linelist_cleaned)` meningitis cases have been reported since the start of the outbreak.
...
- There have been `r fmt_count(linelist_cleaned, patient_sex == "Female")` females and `r fmt_count(linelist_cleaned, patient_sex == "Male")` males. 
...
- [Add a line here about laboratory-confirmed cases as needed]


<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Epicurve: See section 3.5.3 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

**Meningitis cases by week of symptom onset **  
...
all_weeks <- seq(min(linelist_processing$epiweek_combined),
                 reporting_date, by = 7) 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Age and sex distribution: See section 3.5.4 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

- Among `r fmt_count(linelist_cleaned, !is.na(patient_sex) & patient_sex != "Unknown/unspecified")` cases with available sex information, `r fmt_count(linelist_cleaned, patient_sex == "Female")` were females and `r fmt_count(linelist_cleaned, patient_sex == "Male")` were males.
...
**Distribution of age-group among meningitis cases, by sex**  
_Age-group percentages calculated among those with non-missing age_
```{r total_props_agegroup_sex}

linelist_cleaned |> 
  select(age_group, patient_sex) |> 
  mutate(patient_sex = forcats::fct_explicit_na(patient_sex, "Missing")) |>
  tbl_summary(by = patient_sex,
              percent = "cell",
...
**Age-sex pyramid**  
_Excludes `r fmt_count(linelist_cleaned, is.na(date_combined) | is.na(patient_sex))` of `r nrow(linelist_cleaned)` cases with missing age or sex information_
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Symptoms and malnutrition: See section 3.5.5 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

**Percentage of cases experiencing different symptoms and malnutrition, by age group**
_Percentages calculated among those with complete information, i.e. those reporting "Yes" or "No" for each symptom_
```{r symptoms}
...
linelist_cleaned |> 
  ...
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(sympt_fever = "Fever",
         sympt_neck_stiffness = "Neck stiffness",
         sympt_vomitting = "Vomiting",
         sympt_altered_consciousness = "Altered consciousness",
         sympt_purpura = "Purpura",
         malnut_adm = "Malnutrition"),
        missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Attack rate: See section 3.5.6 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
linelist_cleaned |> 
  ...
  mutate(age_group = factor(age_group, levels = c("<1", "1-4", "5-14", "15-29", "30+", "Total"), ordered = TRUE)) |> 
...
table_ar_adm2 <- linelist_cleaned |> 
  ...
  # Calculate CFR and AR, including linkage of population data
  mutate(CFR = deaths/cases*100) |> 
  left_join(population_data_adm2 |>  adorn_totals(), by = "adm2_residence") |> 
  mutate(attack_rate_result = cases/population*10000) 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Vaccination, laboratory results, and outcomes: See section 3.5.7 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

# Vaccination against _Neisseria_

**Status of vaccination against _Neisseria_ (meningococcal vaccines), by age group**  
_Percentages calculated among those with non-missing vaccination history_
```{r vaccination}

linelist_cleaned |> 
  select(vacci_status_nm, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_status_nm = "Previously vaccinated"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Number and proportion of previously vaccinated persons whose vaccine history against _Neisseria_ was confirmed with vaccine card, by age group**    
_Percentages calculated among previously vaccinated with non-missing vaccination card information_
```{r vaccination_dosesl}

linelist_cleaned |> 
  filter(vacci_status_nm=="Yes") |> 
  select(vacci_card_nm, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(vacci_status_nm = "Previously vaccinated",
                           vacci_card_nm = "Evidence of card"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Lab results of cases by test and age group**  
_Percentages calculated among those with non-missing test results, per test type_
```{r lab}

linelist_cleaned |> 
  select(latex_result, pcr_result, culture_result, age_group) |> 
  tbl_summary(percent = "column",
              by = "age_group",
              label = list(latex_result = "LATEX results",
                           pcr_result = "PCR results",
                           culture_result = "Culture results"),
              missing_text = "[Missing]") |> 
  add_overall()  |>
  ## make variable names bold 
  bold_labels() |> 
...
**Final outcome of cases by age group**  
_Percentages calculated among cases with non-missing outcome information_
```{r diagnosis_outcome_age}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic distribution - tables: See section 3.5.8 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
\newpage
**Cases by week of onset and `r str_to_lower(adm2_residence_name)`**  
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Geographic distribution - maps: See section 3.5.9 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
...
```{r choropleth_map_ar, message = FALSE, warning = FALSE, fig.height=7}
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Geographic details: See section 3.5.10 in the meningitis outbreak report guide
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

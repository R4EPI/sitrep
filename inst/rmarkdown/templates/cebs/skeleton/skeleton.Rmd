...
Across the period of evaluation, there were `r fmt_count(ewar_cleaned, ALERT)` of which `r nrow(filter(ewar_cleaned, ALERT, response_undertaken == "y"))` resulted in public health action.

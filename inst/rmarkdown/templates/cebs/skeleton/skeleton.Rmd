...
This is a template which can be used to create an automated EWAR situation report and for routine monitoring purposes
...
## Numeric variables -----------------------------------------------------------
## This step creates numeric variables related to timeliness of CEBS activities
...
## or not
cebs_cleaned$ALERT <- str_detect(cebs_cleaned$exit_status, "1")
...
map <- gen_polygon(regions = unique(cebs_cleaned$location_signal))

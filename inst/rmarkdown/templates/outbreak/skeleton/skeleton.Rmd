...
options(knitr.kable.NA = "-", fig.width = 16, fig.height = 12)
...
linelist_cleaned[ , grep("date|Date", names(linelist_cleaned))] <- lapply(
                    linelist_cleaned[ , grep("date|Date", names(linelist_cleaned))], 
                    as.Date)
...
univariate_analysis(measure = "OR", 
  ...
  mutate(Exposure = recode(Exposure, 
    ...
    huxtable::set_col_width(c(3, 1, 1, 1, 1, 1, 2)) %>%

...
survey_data_hh <- survey_hhdata  # responese from household members
...
A successful import should result in 4 data frame objects in your RStudio Environment pane, as shown below:  
...
Th example command below imports an Excel spreadsheet that is not password protected, and is stored in a "Data" subfolder of the RStudio project. The `which =` argument of `import()` specifies that the sheet "Sheet1" should be imported. You would edit this command as appropriate for your situation.
...
linelist_raw <- rio::import(here::here("Data", "linelist.xlsx"), which = "Sheet1", na = "")
```
...
Below is the code for the column assignments used in this case study vignette. You can copy or reference this when building your template for this vignette.

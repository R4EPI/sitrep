...
Each of these options will result in the use of different code chunks in the template. **This walk-through uses data collected with Kobo**.
...
A successful import should result in a dataframe object named `linelist_raw` in your RStudio Environment pane, consisting of 1447 observations and 122 columns.The data for this walk-through can be accessed using the following command:

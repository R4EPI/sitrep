# These functions have been re-exported from the \pkg{epitabulate} package. They were
...
#' Functions re-exported from \pkg{epitabulate}
#'
...
#'  - [epitabulate::add_ar()]: a \pkg{gtsummary} wrapper for epitabulate::attack_rate()
#'  - [epitabulate::add_cfr()]: a \pkg{gtsummary} wrapper for
#'    epitabulate::case_fatality_rate()
#'  - [epitabulate::add_crosstabs()]: a \pkg{gtsummary} wrapper to add counts to
#'    a gtsummary::tbl_uvregression()
#'  - [epitabulate::add_mr()]: a \pkg{gtsummary} wrapper for epitabulate::mortality_rate()
#'  - [epitabulate::gt_remove_stat()]: a \pkg{gtsummary} wrapper to remove variables
#'    from a gtsummary table
#'  - [epitabulate::tbl_cmh()]: a \pkg{gtsummary} wrapper to calculate stratified
